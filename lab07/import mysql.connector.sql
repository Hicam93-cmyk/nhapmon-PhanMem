...
if __name__ == "__main__":
    # Thêm bài viết
    add_post("Khai trương chi nhánh mới", "Chi nhánh mới tại Quận 1 đã mở.", "Tracy")
    add_post("Khuyến mãi tuần này", "Giảm 20% cho khách hàng đầu tiên.", "Luca")

    # Duyệt bài viết
    approve_post(1, "Tracy")  # admin duyệt
    approve_post(2, "Luca")   # không phải admin -> báo lỗi
